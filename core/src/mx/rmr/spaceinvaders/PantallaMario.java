...
class PantallaMario extends Pantalla
{
    ...
    private OrthogonalTiledMapRenderer rendererMapa;    // Dibujar el mapa
        ...
        pad.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                if (pad.getKnobPercentX()>0 ) {
                    ...
                    mario.sprite.setX(mario.sprite.getX()+5);
                } else {
    ...
    private void actualizarCamara() {
        float xMario = mario.sprite.getX();
        float nuevaXcamara = mario.sprite.getX();
        if (xMario<ANCHO/2) {
            nuevaXcamara = ANCHO/2;
        } else if (xMario>ANCHO_MAPA-ANCHO/2) {
            nuevaXcamara = ANCHO_MAPA-ANCHO/2;
        }

        float nuevaYcamara = camara.position.y;
        camara.position.set(nuevaXcamara, nuevaYcamara, 0);
        camara.update();
    }
